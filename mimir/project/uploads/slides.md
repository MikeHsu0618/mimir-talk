...
<div class="rounded-xl px-3 py-2" style="background:rgba(242,109,79,0.07);border:1.5px solid rgba(242,109,79,0.30);">
  <div class="text-xs uppercase tracking-widest font-bold" style="color:#C0502E;">傳統 Kafka 三大詬病</div>
  <div class="text-xs opacity-80 mt-1" style="line-height:1.5;">Broker <strong>有狀態</strong> · <strong>Rebalance storm</strong> · 跨 AZ replication 流量佔 <strong>60–70%</strong> 成本</div>
</div>
