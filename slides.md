...
<h3 style="color:#5296B8">結構性瓶頸</h3>
...
<li v-click><mdi-memory /> 重度查詢 → SG 直接 <strong style="color:#F26D4F;">OOM</strong></li>
</ul>

<div v-click class="mt-2 text-sm" style="color:#35738E;">
→ Store Gateway 一失守，<strong style="color:#F26D4F;">整個長期查詢鏈路就崩</strong>
</div>
...
<div class="rounded-xl p-4" style="background:linear-gradient(to bottom right, rgba(247,168,107,0.15), rgba(247,168,107,0.04));border:1px solid rgba(247,168,107,0.35);">
  <div style="font-size:0.65rem;text-transform:uppercase;letter-spacing:0.1em;color:#F7A86B;font-weight:700;margin-bottom:0.25rem;">Reliability</div>
  <div style="font-weight:700;font-size:0.9rem;margin-bottom:0.35rem;">寫讀徹底解耦</div>
  <div style="font-size:0.76rem;opacity:0.78;line-height:1.55;">Kafka 中繼 · 讀端掛了寫依然健康 · quorum 從 2/3 降到 1</div>
</div>

<div class="rounded-xl p-4" style="background:linear-gradient(to bottom right, rgba(82,150,184,0.15), rgba(82,150,184,0.04));border:1px solid rgba(82,150,184,0.35);">
  <div style="font-size:0.65rem;text-transform:uppercase;letter-spacing:0.1em;color:#5296B8;font-weight:700;margin-bottom:0.25rem;">Performance</div>
  <div style="font-weight:700;font-size:0.9rem;margin-bottom:0.35rem;">Mimir Query Engine</div>
  <div style="font-size:0.76rem;opacity:0.78;line-height:1.55;">Streaming 取代全量載入 · Peak CPU ↓80% · Peak Mem ↓3×</div>
</div>

<div class="rounded-xl p-4" style="background:linear-gradient(to bottom right, rgba(242,109,79,0.15), rgba(242,109,79,0.04));border:1px solid rgba(242,109,79,0.35);">
  <div style="font-size:0.65rem;text-transform:uppercase;letter-spacing:0.1em;color:#F26D4F;font-weight:700;margin-bottom:0.25rem;">Cost</div>
  <div style="font-weight:700;font-size:0.9rem;margin-bottom:0.35rem;">Ingester 減半</div>
  <div style="font-size:0.76rem;opacity:0.78;line-height:1.55;">Zones 從 3 降到 2 · 副本不靠 RF=3 · ~25% TCO ↓</div>
</div>
...
---
layout: split
title: "Ingest Storage — 從「3 副本寫入」到「1 次 Kafka produce」"
ratio: "1:1"
---

::left::

<h3 class="!text-xs !uppercase !tracking-widest mb-1" style="color:#C0502E;">Mimir v2 · Classic</h3>
